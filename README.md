...
- Добавлено .exe-приложение. Убран функционал уменьшения даты. Теперь если нет даты, выводится текстовое уведомление 


## 4.1

- Добавлена возможность парсинга с помощью playwright

## 4.2

- Удалена таблица всех матчей и возможность работы с ней
...
- Правки кода, фикс возможности сохранить файл. 
- Добавление замены некоторых символов в названии файла при сохранении 

## 4.2.4. 
- Правки кода, MatchDTO стал открытым и потерял все сеттеры 